...
export default function Nav() {
  ...
  return (
    <>
      ...
      >
        <div className="nav-item close menu" onClick={e => handleSetClose(e)}>
          <Menu id="closebtn" className="svg menu" />
      ...
      <div className="open" id="open-container" onClick={e => handleSetOpen(e)}>
        <Menu id="openbtn" className="svg menu closebtn" />
      </div>
    </>
  );
}
